...
export const projects = [
  {
    ...
    about:
      "This application boosts productivity by helping users prioritize tasks, stay organized, and achieve their goals efficiently.",
  },
  {
    id: 1,
    img: Array.from({ length: 15 }, (_, i) => `/cmembo/cmemboApp${i}.png`),
